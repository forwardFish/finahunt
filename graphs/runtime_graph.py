...
def build_runtime_graph():
    ...
    graph.add_edge("structured_result_cards", "result_warehouse")
    graph.add_edge("result_warehouse", "theme_heat_snapshot")
    graph.add_edge("theme_heat_snapshot", "fermenting_theme_feed")
